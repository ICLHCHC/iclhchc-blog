...
[归档](https://kuizuo.cn/blog/archive)、[友链](https://kuizuo.cn/friends)、[导航](https://kuizuo.cn/resources)、[项目](https://kuizuo.cn/project)以及[关于我](https://kuizuo.cn/about)页面都在 `src/pages` 目录下定义，根据文件名映射对应路由。页面的创建可以查看 [创建页面 | Docusaurus](https://docusaurus.io/zh-CN/docs/creating-pages)